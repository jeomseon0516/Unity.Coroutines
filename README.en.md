...
Requires Unity 6000.6.0f1 or newer and `com.jeomseon.unity.singleton` 0.3.1 or newer.
...
```json
{
  ...
  "dependencies": {
    "com.jeomseon.unity.coroutines": "0.4.1"
  }
}
```
...
```text
https://github.com/jeomseon0516/Unity.Coroutines.git#v0.4.1
```
